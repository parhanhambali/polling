<template>
  <div class="buttons">
    <button v-for="(emoticon, index) in emoticons" :key="index" :id="emoticon" value="emoticon" class="btn-emoticon" @click="vote"></button>
  </div>
</template>
...
export default {
  ...
  data: function () {
    return {
      emoticons: ['very-bad', 'bad', 'okay', 'good', 'very-good'],
    };
  },
  methods: {
    vote(e) {
